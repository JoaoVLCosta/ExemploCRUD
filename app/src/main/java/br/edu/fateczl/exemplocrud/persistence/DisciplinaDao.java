...
public class DisciplinaDao implements IDisciplinaDao, ICRUDDao<Disciplina> {
    ...
    public int update(Disciplina disciplina) throws SQLException {
        ContentValues contentValues = getContentValues(disciplina);
        int ret = database.update("disciplina", contentValues,
                "codigo = " + disciplina.getCodigo(), null);
        return ret;
    }
    ...
    private static ContentValues getContentValues(Disciplina d) {
        ContentValues contentValues = new ContentValues();
        contentValues.put("codigo", d.getCodigo());
        contentValues.put("nome", d.getNome());
        contentValues.put("codigo_professor", d.getProfessor().getCodigo());
