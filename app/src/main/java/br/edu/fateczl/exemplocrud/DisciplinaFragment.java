...
public class DisciplinaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnListarDisc.setOnClickListener(op -> acaoBuscar());
        btnBuscarDisc.setOnClickListener(op -> acaoListar());

        return view;
    }

    private void acaoInserir() {
        int sPos = spProfDisc.getSelectedItemPosition();
        if(sPos > 0){
            Disciplina disciplina = montaDisciplina();
            Toast.makeText(view.getContext(), "Disciplina Inserida com Sucesso",
            ...
            Toast.makeText(view.getContext(), "Selecione um professor",
                    Toast.LENGTH_LONG).show();
        }
    }
    ...
    private void acaoModificar() {
        ...
        if(sPos > 0){
            Disciplina disciplina = montaDisciplina();
            Toast.makeText(view.getContext(), "Disciplina Atualizada com Sucesso",
                    Toast.LENGTH_LONG).show();
            try {
    ...
    private void acaoExcluir() {
        Disciplina disciplina = montaDisciplina();
            try {
                ...
                Toast.makeText(view.getContext(), "Disciplina Excluida com Sucesso",
                        Toast.LENGTH_LONG).show();
            } catch (SQLException e) {
                Toast.makeText(view.getContext(), e.getMessage(), Toast.LENGTH_LONG).show();
            }
    ...
    private void acaoBuscar() {
        ...
        try {
            ...
            if(disciplina.getNome() != null){
                ...
                Toast.makeText(view.getContext(), "Disciplina Não Encontrada",
                        Toast.LENGTH_LONG).show();
                limpaCampos();
            }
        } catch (SQLException e) {
